                            ...
                            <form id="file-upload-form" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="drop-area" class="u-align-center u-container-style u-group u-palette-1-base u-group-1" style="background-color: white;">
                                    <div style="display:block;" class="u-container-layout u-valign-middle u-container-layout-3">
                                        <h1 id="text" style="font-size: 25px;color: black;display: block;user-select: none;">drag</h1>
                                        <p style="display: block;user-select: none;" id="or">or</p>
                                        <label style="display: block;user-select: none;" for="file-input" id="file-label">choose</label>
                                ...
                                <p class="u-text u-text-default u-text-3" style="user-select: none;text-align: center;font-size: 1rem;color:black">Thả tệp của bạn tại đây, chọn định dạng văn bản bạn muốn chuyển đổi sang, và tệp chuyển đổi theo yêu cầu của bạn sẽ được tự động tải xuống máy bạn</p>
                                <div id="flex">
...
<script>
    ...
    function load(files) {
        ...
        form.onsubmit = (e) => {
            ...
            switch (idbutton) {
                case "1":
                    url = 'http://localhost:8000/api/word-to-pdf'
                    break;
                case "2":
                    url = 'http://localhost:8000/api/word-to-pdf' //tạm thời ch có
                    break;
                case "3":
                    url = 'http://localhost:8000/api/pdf-to-txt' //txt
                    break;
                case "4":
                    url = 'http://localhost:8000/api/txt-to-json'
                    break;
                default:
                    location.reload();
                    break;
